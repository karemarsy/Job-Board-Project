...
import { submitApplication, resetSubmissionStatus } from '@/lib/redux/slices/applicationSlice';
...
const applicationSchema = z.object({
  ...
  resume: z.string().min(10, 'Please provide a brief resume or experience summary'),
...
const ApplicationForm: React.FC<ApplicationFormProps> = ({ 
  ...
  const { submissionStatus, error } = useAppSelector((state) => state.applications);
  ...
  useEffect(() => {
    // Reset submission status when component mounts
  ...
  useEffect(() => {
    // Auto close on successful submission after 3 seconds
